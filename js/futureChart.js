...
export function createFutureChart(historical, projections, containerId = "futureChart") {
    ...
    // Attach last historical point to each scenario so lines connect
    ...
    // Scenario labels at rightmost points
